...
面向不同背景申请者的通用硕士项目筛选平台。当前目录包含 42 所院校、49 个经济学与商科相关硕士项目；录取要求、语言、学费、学制和截止日期均按专业记录，QS、城市和院校官网属于院校层信息。
...
- 49 个独立项目详情页；首页先以院校为推荐单位，进入院校页后再选择专业；
...
scripts/export-static-site.mjs    首页及 28 个详情页静态导出
...
输出目录为 `out/`，包含首页、49 个专业详情页和 42 个院校页。
