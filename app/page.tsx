const regions = [
  ...
  { name: "湾区校区", kicker: "Greater Bay Ledger", count: 4, qs: 0, color: "#8C3D2E", note: "新增港中深与港城大（东莞）" },
];
  ...
  return (
    <main>
      <header className="topbar shell">
        <div className="brand">CX · ADMISSIONS DOSSIER</div>
        <a className="excel" href="/陈昕洋_2027硕士项目研究与预算决策表.xlsx">下载 Excel 原表 ↗</a>
      </header>
